implantData = {
    ...
    "flexClass": {
        "description": "The flexClass is subdermal flex implant, conceived of and designed by community member @leumas95, is fully encapsulated in our custom biopolymer. It contains a 13.56MHz high frequency programmable HID standard (legacy) iClass transponder chip that allows you to *enroll it with your HID access system, or use our Proxmark3 RFID research tool to clone / copy an HID iClass credential to it.",
